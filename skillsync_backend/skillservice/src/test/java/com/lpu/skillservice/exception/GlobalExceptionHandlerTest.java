...
class GlobalExceptionHandlerTest {
    ...
    void testHandleCustomException() {
        ResponseEntity<Map<String, Object>> resp =
                handler.handleCustom(new CustomException("Skill already exists"));
        assertEquals(HttpStatus.BAD_REQUEST, resp.getStatusCode());
        assertEquals("Skill already exists", resp.getBody().get("message"));
    }
    ...
    void testHandleEntityNotFoundException() {
        ResponseEntity<Map<String, Object>> resp =
                handler.handleNotFound(new EntityNotFoundException("Skill not found"));
        assertEquals(HttpStatus.NOT_FOUND, resp.getStatusCode());
        assertEquals("Skill not found", resp.getBody().get("message"));
    }
    ...
    void testResponseBodyStructure() {
        ResponseEntity<Map<String, Object>> resp =
                handler.handleCustom(new CustomException("check"));
