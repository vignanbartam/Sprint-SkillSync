...
/**
 * CORS - Cross- origin Resource Sharing Config — allows frontend (React/Angular) to call this service.
 * CSRF is already disabled in SecurityConfig (stateless JWT APIs don't need it).
 *
 * WHERE TO PASTE: authservice/src/main/java/com/lpu/authservice/config/CorsConfig.java
